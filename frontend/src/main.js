...
pluralCaseList.push( {plural: "cleantasks/cleanTasks", pascal: "CleantaskCleanTask"} )

pluralCaseList.push( {plural: "reservations/reservations", pascal: "ReservationReservation"} )

pluralCaseList.push( {plural: "lostitems/lostItems", pascal: "LostitemLostItem"} )

pluralCaseList.push( {plural: "confirms/confirms", pascal: "ConfirmConfirm"} )
